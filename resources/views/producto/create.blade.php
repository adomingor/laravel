                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Create') }} Producto</h1>
                            <p class="mt-2 text-sm text-gray-700">{{ __('Add') }} {{ __('Producto') }}.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="w-9/12 py-2 align-middle px-1">
