<div class="w-full h-screen flex flex-col">
    <!-- Contenedor Superior: Dos divs al 50% -->
    <div class="flex w-full">
        ...
        <div class="w-1/2 p-1">
            ...
            <x-input-label :value="__('Categorías del Producto')" class="mb-4 text-base font-bold text-gray-800" />
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200 max-h-[500px] overflow-y-auto">
    ...
    <!-- Contenedor Inferior: Un div al 100% -->
